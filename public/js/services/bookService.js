...
class bookService {
    initialBooks = [
        {
            id: 0,
            genreId : "1", 
            name: "Принцеса Аннелі і наймиліший у світі поні I. Солодкий ліс",
            author: "Анналена Лухс",
            price: 93,
            image: "/public/img/IMG_1341.JPG",
        ...
        },
        {
            id: 1,
            genreId : "1", 
            name: "Принцеса Аннелі і наймиліший у світі поні II. Чарівний привид місячного сяйва",
            author: "Анналена Лухс",
            price: 93,
            image: "/public/img/IMG_1342.JPG",
        ...
        },
        {
            id: 2,
            genreId : "1", 
            name: "Принцеса Аннелі і наймиліший у світі поні III. Бал на Суничному озері",
            author: "Анналена Лухс",
            price: 93,
            image: "/public/img/IMG_1343.JPG",
    ...
    addBook(book) {
        let current = this.getBooks();
    
        const nextId = this.getNextId(current);
        book.id = nextId;
    ...
    initLocalStorage() {
        ...
        const hasItems = localStorage.getItem(this.storageKey);
        if (!hasItems){
            console.log("init books added");
...
_bookService.initLocalStorage()

export default _bookService;